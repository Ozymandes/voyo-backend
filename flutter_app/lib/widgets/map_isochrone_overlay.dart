...
class IsochroneController extends ChangeNotifier {
  ...
  /// Fetch reachable-area rings from [point], fit them into view, and show a
  /// reachable-POI summary. [poiPoints] are all loaded POI coordinates (used
  /// for the point-in-polygon count). [context] is used only to surface the
  /// summary sheet; it is not retained.
  Future<void> explore(
    LatLng point,
...
/// Reachable-POI summary sheet. Shown after a successful explore(). The
/// "Clear" action resets the [controller].
                ...
                RichText(
                  text: TextSpan(
                    ...
                    children: [
                      ...
                      TextSpan(
                        text:
                            ' ${reachableCount == 1 ? "place" : "places"} in the VOYO database.',
                      ),
                    ],
                  ),
                ),
